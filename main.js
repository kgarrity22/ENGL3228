...
var i = 0;
var txt = "Black joy is...";
var speed = 80;
var descriptions = ["", "important", "worth celebrating", "necessary", "powerful", "essential", "beautiful"]
var j = 0;
...
function typeWriter() {
    ...
    if (i < txt.length) {
        ...
        i++;
        if (get_text.textContent !== "Black joy is") {
        ...
        if (i == txt.length) {
            ...
            var new_text = get_text.textContent.slice(0, 12)
            ...
            if (j < descriptions.length - 1) {
                ...
                get_text.textContent = "Black joy is beautiful";
                //particles();
                // return particles();
                initial_ended = true;
                particles()
